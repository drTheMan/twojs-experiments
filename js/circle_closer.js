...
(function() {
  ...
  this.CircleCloser = (function(_super) {
    __extends(CircleCloser, _super);
    ...
    CircleCloser.prototype.destroy = function() {
      this.trigger('destroy');
      if (this.polygon) {
        this.two.remove(this.polygon);
      }
      if (this.polygon2) {
        this.two.remove(this.polygon2);
      }
      if (this.group) {
  ...
  this.CircleCloserOperations = (function() {
    function CircleCloserOperations(opts) {
      ...
      this.target().on('destroy', function() {
        return console.log("TODO: CircleCloserOperation's tweens");
      });
    }
