...
(function() {
  ...
  RingerPart = (function() {
    ...
    RingerPart.prototype.destroy = function() {
      this.two.remove(this.polygon);
      if (this.group) {
        this.two.remove(this.group);
      }
      return this.polygon = this.group = void 0;
    };
  ...
  this.Ringer = (function(_super) {
    __extends(Ringer, _super);
    ...
    Ringer.prototype.destroy = function() {
      this.trigger('destroy');
      _.each(this.ringer_parts, function(part) {
        return part.destroy();
      });
      return this.ringer_parts = void 0;
    };
  ...
  this.RingerOperations = (function() {
    function RingerOperations(opts) {
      ...
      this.target().on('destroy', function() {
        return console.log("TODO: RingerOperations' tweens");
      });
    }
